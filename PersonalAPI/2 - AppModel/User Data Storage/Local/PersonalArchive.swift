...
struct PersonalArchive: Codable {
    ...
    struct MomentRecord: Codable {
        ...
        init(_ moment: MomentSnapshot) {
            id = moment.id; text = moment.text; createdAt = moment.createdAt
            happenedAt = moment.happenedAt; source = moment.source
            processingState = moment.processingState; derived = moment.analysis
