...
@MainActor final class LifeMapTests: XCTestCase {
    private func entry(_ text: String) -> MomentSnapshot {
        .init(id: UUID(), text: text, createdAt: Date(), happenedAt: nil, source: "journal", analysisData: nil, processingState: "pending")
    }
    func testThreeEntriesCanProduceFiveSourceBackedMoments() async throws {
        let repository = MemoryRepository()
        for text in ["I graduated.|I moved to London.", "I started work.|I met Sam.", "I adopted a dog."] {
